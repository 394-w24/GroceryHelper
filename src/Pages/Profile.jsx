...
const Profile = () => {
  ...
  const [sendBefore, setSendBefore] = useState(getTime());
  ...
  const [sendTime, setSendTime] = useState(getSendTime());

  useEffect(() => {
    console.log(dayjs("07:00", "HH:mm"));
  ...
  return (
    <Box>
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          <Tab label="Profile" />
          <Tab label="Notifications" data-testid="notification-tab" />
        </Tabs>
      </Box>
      <Box sx={{ padding: 3 }}>
        {tabValue === 1 && (
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              >
                Receive newsletter to stay up-to date with expiring groceries
        ...
        {tabValue === 0 && (
          <Box>
            ...
            >
              ...
              <Typography variant="h1" sx={{ ml: 1, fontSize: "28px" }}>
                {name}
              </Typography>
            </Box>
